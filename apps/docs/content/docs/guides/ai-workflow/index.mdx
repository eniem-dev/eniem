...
The AI workflow is an autonomous development system that uses Claude Code to implement features from specifications. It follows a spec-driven approach: define requirements, plan tasks, then build iteratively — producing atomic commits, tested code, and PRs automatically.
