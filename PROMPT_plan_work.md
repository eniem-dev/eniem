...
Study existing source code in `src/*` and `content/*` with up to 500 Sonnet subagents and compare it against `specs/*`, focusing ONLY on the work scope defined above.
